...
@Controller
public class AccountingPhieuThuKhachHangController extends BaseFormController {
	 ...
	 * 
	 */
	public AccountingPhieuThuKhachHangController() {
		setCancelView("redirect:" + URLReference.ACCOUNTING_PHIEUTHU_LIST_CUSTOMER);
		setSuccessView("redirect:" + URLReference.ACCOUNTING_PHIEUTHU_LIST_CUSTOMER);
	}

	@RequestMapping(method = RequestMethod.GET, value = URLReference.ACCOUNTING_PHIEUTHU_LIST_CUSTOMER)
...
//		model.addAttribute(refundManager.findAllPhieuThu());
		...
		return new ModelAndView(URLReference.ACCOUNTING_PHIEUTHU_LIST_CUSTOMER, model.asMap());
	}
	...
	@RequestMapping(method = RequestMethod.GET, value = URLReference.ACCOUNTING_PHIEUTHU_CUSTOMER)
	...
	@RequestMapping(method = RequestMethod.POST, value = URLReference.ACCOUNTING_PHIEUTHU_SEARCH_CUSTOMER)
	public ModelAndView searchRefund(Search searchRefund,
			HttpServletRequest request) throws Exception {
		ModelAndView mav = new ModelAndView(URLReference.ACCOUNTING_PHIEUTHU_LIST_CUSTOMER);
	 ...
	 @RequestMapping(method = RequestMethod.POST, value=URLReference.ACCOUNTING_PHIEUTHU_CUSTOMER)
	    ...
	    throws Exception {
	        ...
	        if (validator != null) { // validator is null during testing
	            ...
	            if (errors.hasErrors() && request.getParameter("delete") == null) { // don't validate when deleting
	                return URLReference.ACCOUNTING_PHIEUTHU_LIST_CUSTOMER;
	            }
	        }
