...
public interface TruckingdetailRepository extends GenericRepository<Truckingdetail> {
	...
	@Query("from Truckingdetail t LEFT JOIN FETCH t.exfeetables LEFT JOIN FETCH t.truckingservice where t.nhathau.id=:nhathauId and t.dateDev between :startDate and :endDate")
