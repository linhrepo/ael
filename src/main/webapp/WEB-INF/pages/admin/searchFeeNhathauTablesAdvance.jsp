	...
	<form:form commandName="search" method="post"
		...
		<div class="row">
			<div class="form-group col-md-2">
				<button id="btn-search-advance-admin" type="submit" class="btn btn-primary" onclick="bCancel=false" name="search"><i class="fa fa-search"></i> <fmt:message key="button.search"></fmt:message></button>
			</div>
		</div> 
	</form:form>
