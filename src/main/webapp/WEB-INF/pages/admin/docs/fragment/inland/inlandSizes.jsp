...
<h3>
	<fmt:message key="inland.tableDetail" />
</h3>
<hr>
<table id="inlandsizes"
	...
	<tbody>
		<c:forEach items="${inland.docsgeneral.inlandsizes}" var="ser"
			varStatus="idx">
			...
			<td colType="generalInfo" class="hidden">
				...
				<td><spring:bind
					path="inland.docsgeneral.inlandsizes[${idx.index}].deep">
						<div
				...
				<td><spring:bind
					path="inland.docsgeneral.inlandsizes[${idx.index}].width">
						<div
						class="form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
				...
				<td><spring:bind
					path="inland.docsgeneral.inlandsizes[${idx.index}].height">
						<div
						class="form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
				...
				<td><spring:bind
					path="inland.docsgeneral.inlandsizes[${idx.index}].kg">
						<div
						class="form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
