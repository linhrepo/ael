<%@ include file="/common/taglibs.jsp"%>
        ...
        <tbody>
        <c:forEach items="${packageInfo.docsgeneral.attachments}" var="attachment" varStatus="idx">
                ...
                <td colType="generalInfo" class="hidden">
              	...
              	<td>
					    ...
					    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
					        ...
					        <form:input path="docsgeneral.attachments[${idx.index}].description" id="description${idx.index}" cssClass="form-control"/>
