...
<div class="row">
	    ...
	    <div class="row">
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-2">
		        ...
		        <form:select path="typeOfTransport.id" id="typeOfTransport"  autofocus="true" cssClass="form-control select2" items="${docsSelection.selections['typeOfTransports']}"/>
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-2">
		        ...
		        path="docsgeneral.typeOfContainer.id" id="typeOfContainer"  autofocus="true" cssClass="form-control select2" items="${docsSelection.selections['typeOfContainers']}"/>
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-4">
		        ...
		        <form:input path="shipper" id="shipper" maxlength="45" autofocus="true" cssClass="form-control"/>
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-4">
		        ...
		        <form:input path="nameVehicle" id="nameVehicle" maxlength="45" autofocus="true" cssClass="form-control"/>
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-2">
		        ...
		        <form:input path="po" id="po" maxlength="45" autofocus="true" cssClass="form-control"/>
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-2">
		        ...
		        <form:input path="invoice" id="invoice" maxlength="45" autofocus="true" cssClass="form-control"/>
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-2">
		        ...
		        <form:input path="consignee" id="consignee" maxlength="45" autofocus="true" cssClass="form-control"/>
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-2">
		        ...
		        <form:input path="billOfLading" id="billOfLading" maxlength="45" autofocus="true" cssClass="form-control"/>
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-3">
		        ...
		        <form:input path="portOfLoading" id="portOfLoading" maxlength="45" autofocus="true" cssClass="form-control"/>
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-3">
		        ...
		        <form:input path="portOfArrival" id="portOfArrival" maxlength="45" autofocus="true" cssClass="form-control"/>
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-2">
		        ...
		        <form:input path="freeDemDate" id="freeDemDate" data-provide="datepicker" maxlength="45" autofocus="true" cssClass="form-control"/>
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-2">
		        ...
		        <form:input path="freeDetDate" id="freeDetDate" data-provide="datepicker" maxlength="45" autofocus="true" cssClass="form-control"/>
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-2">
		        ...
		        <form:select path="docsgeneral.shippingLine.id" id="shippingLine"  autofocus="true" cssClass="form-control select2" items="${docsSelection.selections['shippingLines']}"/>
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-3">
		        ...
		        <form:input path="wareHouseNo" id="wareHouseNo" maxlength="45" autofocus="true" cssClass="form-control"/>
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-3">
		        ...
		        <form:select path="customsDept.id" id="customsDept"  autofocus="true" cssClass="form-control" items="${docsSelection.selections['customDepts']}"/>
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-3">
		        ...
		        <form:input path="docsgeneral.placeDelivery" id="placeDelivery" maxlength="45" autofocus="true" cssClass="form-control"/>
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-3">
		        ...
		        <form:input path="docsgeneral.placeRev" id="placeRev" maxlength="45" autofocus="true" cssClass="form-control"/>
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-3">
		        ...
		        <form:input path="docsgeneral.placeEmptyDown" id="placeEmptyDown" maxlength="45" autofocus="true" cssClass="form-control"/>
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-3">
		        ...
		        <form:input path="docsgeneral.placeEmptyUp" id="placeEmptyUp" maxlength="45" autofocus="true" cssClass="form-control"/>
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-2">
		        ...
		        <form:select path="colourApplying.id" id="colourApplying"  autofocus="true" cssClass="form-control" items="${docsSelection.selections['colourApplyings']}"/>
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-2">
		        ...
		        <form:input path="customsDate" id="customsDate" data-provide="datepicker" maxlength="45" autofocus="true" cssClass="form-control"/>
		    ...
		    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-2">
		        ...
		        <form:input path="cusDecOnNo" id="cusDecOnNo" maxlength="45" autofocus="true" cssClass="form-control"/>
