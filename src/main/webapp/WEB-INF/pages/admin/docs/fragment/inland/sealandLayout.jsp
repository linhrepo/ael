	    ...
	    <div class="row">
		    ...
		    <spring:bind path="inland.etd">
			    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-2">
			        ...
			        <form:input path="etd" provide="datepicker" id="etd"  autofocus="true" cssClass="form-control"/>
			    ...
			    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-2">
			        ...
			        <form:input path="eta" provide="datepicker" id="eta"  autofocus="true" cssClass="form-control"/>
				    ...
				    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-6">
		    		 ...
		    		 <spring:bind path="inland.dateCutOff">
					    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''} col-md-6">
					        ...
					        <form:input path="dateCutOff" id="dateCutOff" provide="datepicker" autofocus="true" cssClass="form-control"/>
