...
<div id="consealContainer">
	<table id="contsealList"
		...
		<tbody>
			<c:forEach items="${packageInfo.docsgeneral.contseals}"
				...
				<tr class="${contseal.isAdded == true ? 'hidden' :''}">
					...
					<td><spring:bind
							path="packageInfo.docsgeneral.contseals[${idx.index}].noOfCont">
							<div
					...
					<td><spring:bind
							path="packageInfo.docsgeneral.contseals[${idx.index}].noSeal">
							<div
								class="form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
					...
					<td><spring:bind
							path="packageInfo.docsgeneral.contseals[${idx.index}].noOfPKGS">
							<div
								class="form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
					...
					<td><spring:bind
							path="packageInfo.docsgeneral.contseals[${idx.index}].weight">
							<div
								class="form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
