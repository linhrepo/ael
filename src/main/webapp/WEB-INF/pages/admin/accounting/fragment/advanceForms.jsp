...
<table id="advanceformListAdmin" class="display nestedDatatable" cellspacing="0" width="100%" 
    	...
    	detailTableInfo="<fmt:message key="table.no"/>,<fmt:message key="advanceform.description"/>,<fmt:message key="advanceform.amount"/>,<fmt:message key="accounting.approval" />,<fmt:message key="accounting.feeAdminApproval" />,<fmt:message key="accounting.changeApproval" />"
    	detailTableMapping="description,amount[money],approvedText[Key],checkByAdminText[Key]"
...
<%--               		</c:if> --%>
    ...
    <table id="advanceformListJob" class="display nestedDatatable" cellspacing="0" width="100%" 
    	childDetailURL="/admin/accounting/advDetail" 
    	emptyMessage="accounting.fees.detailFailed"
    	detailTableInfo="<fmt:message key="table.no"/>,<fmt:message key="advanceform.fileCus"/>,<fmt:message key="advanceform.goodDes"/>,<fmt:message key="advanceform.description"/>,<fmt:message key="advanceform.amount"/>,<fmt:message key="accounting.approval" />,<fmt:message key="accounting.feeAdminApproval" />,<fmt:message key="accounting.changeApproval" />"
    	detailTableMapping="jobNo,goodDes,description,amount[money],approvedText[Key],checkByAdminText[Key]"
    	editDetail="/admin/accounting/changeAdvanceApproval"
    	actionCheck = "checkByAdmin:false,null"
    	actionConfirm = "true"    	
    	successLoadMessage="accounting.fees.detailLoaded"
