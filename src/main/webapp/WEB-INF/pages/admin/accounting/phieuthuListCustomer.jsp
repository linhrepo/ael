...
<br>
<div class="col-sm-10">
	<h2><fmt:message key='menu.acct.listphieuthu.customer'/></h2>
	<jsp:include page="searchPhieuThuCustomer.jsp"></jsp:include>
	<br/>
	
    <div id="actions" class="btn-group">
    	<a class="btn btn-primary" href="<c:url value='phieuthuCustomer?isAdmin=1'/>">
            <i class="fa fa-plus"></i><fmt:message key="button.addPhieuthuCustomer"/></a>
